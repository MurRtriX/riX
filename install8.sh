...
case $selected_option in
    1)
        ...
        json_content='{"listen":":'"$remote_udp_port"'","protocol":"udp","cert":"/root/hy/ca.crt","key":"/root/hy/ca.key","up":"100 Mbps","up_mbps":100,"down":"100 Mbps","down_mbps":100,"disable_udp":false,"resolver":"https://8.8.8.8/dns-query","resolve_preference":"46","disable_mtu_discovery":false,"obfs":"'"$obfs"'","auth_str":"'"$auth_str"'"}'
