...
iptables --t nat -A PREROUTING --source 10.0.0.1 -p udp --destination-port 53 -j ACCEPT
...
iodined -f -c -m 1500 -DDDDD -P ReslvdnetZ 10.0.0.1 peru9v.infinityy.cloudns.biz &
echo -e "$YELLOW"
