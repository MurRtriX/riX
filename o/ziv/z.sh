...
case $selected_option in
    1)
        ...
        #Configure Auth
            echo ""
            echo -e "\033[1;33mZivpn Passwords\033[0m"
        ...
        json_content='{"listen":":'"$remote_udp_port"'","cert":"/root/zv/ca.crt","key":"/root/zv/ca.key","obfs":"'"$obfs"'","auth":{"mode":"passwords","config":['"$auth_str"']}}'
