...
sysctl -w net.netfilter.nf_conntrack_udp_timeout=35
sysctl -w net.netfilter.nf_conntrack_udp_timeout_stream=150
...
echo "net.netfilter.nf_conntrack_udp_timeout_stream=1200" >> /etc/sysctl.conf
