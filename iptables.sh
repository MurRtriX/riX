...
sysctl -w net.ipv4.udp_mem=65536
sysctl -w net.ipv4.udp_mem=131072
sysctl -w net.ipv4.udp_mem=262144
sysctl -w net.ipv4.tcp_mem=786432
sysctl -w net.ipv4.tcp_mem=1048576
sysctl -w net.ipv4.tcp_mem=26777216
...
echo "net.ipv4.udp_mem=65536" >> /etc/sysctl.conf
echo "net.ipv4.udp_mem=131072" >> /etc/sysctl.conf
echo "net.ipv4.udp_mem=262144" >> /etc/sysctl.conf
echo "net.ipv4.tcp_mem=786432" >> /etc/sysctl.conf
echo "net.ipv4.tcp_mem=1048576" >> /etc/sysctl.conf
echo "net.ipv4.tcp_mem=26777216" >> /etc/sysctl.conf
...
echo "net.ipv4.tcp_rmem=4096" >> /etc/sysctl.conf
echo "net.ipv4.tcp_rmem=5242880" >> /etc/sysctl.conf
echo "net.ipv4.tcp_rmem=33554432" >> /etc/sysctl.conf
echo "net.ipv4.udp_wmem_min=16384" >> /etc/sysctl.conf
echo "net.ipv4.tcp_wmem=4096" >> /etc/sysctl.conf
echo "net.ipv4.tcp_wmem=5242880" >> /etc/sysctl.conf
echo "net.ipv4.tcp_wmem=33554432" >> /etc/sysctl.conf
