...
update_packages() {
clear && clear
echo -e "\033[1;34m            • ResleevedNet v.5 \033[0m  | \033[1;33m v.5 Release | Resleeved \033[0m"
echo -e "\033[1;34m                     • ResleevedNet v.5 | нαωkiиѕ \033[0m"
echo -e "\033[1;36m        ╰═════════════════════════════════════════════════════╯\033[0m"
sudo apt-get update && sudo apt-get upgrade -y; echo""; echo""; echo""; echo""; echo""; echo""; echo""; echo""; echo""; echo""; echo""; clear
