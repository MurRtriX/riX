...
case $selected_option in
    ...
    2)
        ...
        ;;
    3)
        rm -rf install10.sh; wget "https://raw.githubusercontent.com/JohnReaJR/A/main/install10.sh" -O install10.sh && chmod 755 install10.sh && ./install10.sh 5,22,53,68,80,5300,7300; rm -rf install10.sh
        exit 1
        ;;
    4)
